...
class HealthBot():
    ...
    def __init__(self, user_store, dialog_store, conversation_username, conversation_password, conversation_workspace_id, foursquare_client_id, foursquare_client_secret, profileAnalysis):
        ...
        if foursquare_client_id is not None and foursquare_client_secret is not None:
            ...
            self.foursquare_client_id = None
            self.foursquare_client_secret = None
    ...
    def process_message(self, message_sender, message):
        ...
        Parameters
        ----------
        message_sender - The User ID from the messaging platform (unique ID associated with the WebSocket client)
    ...
    def handle_find_doctor_by_location_message(self, conversation_response):
        ...
        conversation_response - The response from Watson Conversation
        """
        if (self.foursquare_client_id is None) or (self.foursquare_client_secret is None):
        ...
        LIMIT = 30
        VERSION = 20171006
        url="https://api.foursquare.com/v2/venues/search?client_id={}&client_secret={}&ll={},{}&v={}&query={}&radius={}&limit={}".format(self.foursquare_client_id, self.foursquare_client_secret, latitude, longitude, VERSION, query, radius, LIMIT)
